...
{
  /** Default implementation for LibraryInterface. */
  public static class Default implements org.geometerplus.android.fbreader.libraryService.LibraryInterface
  {
  ...
  public static abstract class Stub extends android.os.Binder implements org.geometerplus.android.fbreader.libraryService.LibraryInterface
  {
    ...
    private static class Proxy implements org.geometerplus.android.fbreader.libraryService.LibraryInterface
    {
      ...
      @Override public java.util.List<java.lang.String> books(java.lang.String query) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_books, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().books(query);
          }
          _reply.readException();
      ...
      @Override public boolean hasBooks(java.lang.String query) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeString(query);
          boolean _status = mRemote.transact(Stub.TRANSACTION_hasBooks, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().hasBooks(query);
          }
          _reply.readException();
      ...
      @Override public java.util.List<java.lang.String> recentBooks() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_recentBooks, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().recentBooks();
          }
          _reply.readException();
          _result = _reply.createStringArrayList();
        }
      ...
      @Override public java.lang.String getBookByFile(java.lang.String file) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_getBookByFile, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getBookByFile(file);
          }
          _reply.readException();
          _result = _reply.readString();
        }
      ...
      @Override public java.lang.String getBookById(long id) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeLong(id);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getBookById, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getBookById(id);
          }
          _reply.readException();
          _result = _reply.readString();
        }
      ...
      @Override public java.lang.String getBookByUid(java.lang.String type, java.lang.String id) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_getBookByUid, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getBookByUid(type, id);
          }
          _reply.readException();
          _result = _reply.readString();
        }
      ...
      @Override public java.lang.String getBookByHash(java.lang.String hash) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_getBookByHash, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getBookByHash(hash);
          }
          _reply.readException();
          _result = _reply.readString();
        }
      ...
      @Override public java.lang.String getRecentBook(int index) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_getRecentBook, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getRecentBook(index);
          }
          _reply.readException();
          _result = _reply.readString();
        }
      ...
      @Override public java.util.List<java.lang.String> authors() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_authors, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().authors();
          }
          _reply.readException();
          _result = _reply.createStringArrayList();
        }
      ...
      @Override public boolean hasSeries() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_hasSeries, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().hasSeries();
          }
          _reply.readException();
          _result = (0!=_reply.readInt());
        }
      ...
      @Override public java.util.List<java.lang.String> series() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_series, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().series();
          }
          _reply.readException();
          _result = _reply.createStringArrayList();
        }
      ...
      @Override public java.util.List<java.lang.String> tags() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_tags, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().tags();
          }
          _reply.readException();
          _result = _reply.createStringArrayList();
        }
      ...
      @Override public java.util.List<java.lang.String> labels() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_labels, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().labels();
          }
          _reply.readException();
          _result = _reply.createStringArrayList();
        }
      ...
      @Override public java.util.List<java.lang.String> titles(java.lang.String query) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeString(query);
          boolean _status = mRemote.transact(Stub.TRANSACTION_titles, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().titles(query);
          }
          _reply.readException();
          _result = _reply.createStringArrayList();
        }
      ...
      @Override public java.util.List<java.lang.String> firstTitleLetters() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_firstTitleLetters, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().firstTitleLetters();
          }
          _reply.readException();
          _result = _reply.createStringArrayList();
        }
      ...
      @Override public boolean saveBook(java.lang.String book) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_saveBook, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().saveBook(book);
          }
          _reply.readException();
          _result = (0!=_reply.readInt());
        }
      ...
      @Override public void removeBook(java.lang.String book, boolean deleteFromDisk) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_removeBook, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().removeBook(book, deleteFromDisk);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public void addToRecentlyOpened(java.lang.String book) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeString(book);
          boolean _status = mRemote.transact(Stub.TRANSACTION_addToRecentlyOpened, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().addToRecentlyOpened(book);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public java.lang.String getHash(java.lang.String book, boolean force) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeString(book);
          _data.writeInt(((force)?(1):(0)));
          boolean _status = mRemote.transact(Stub.TRANSACTION_getHash, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getHash(book, force);
          }
          _reply.readException();
          _result = _reply.readString();
        }
      ...
      @Override public org.geometerplus.android.fbreader.libraryService.PositionWithTimestamp getStoredPosition(long bookId) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_getStoredPosition, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getStoredPosition(bookId);
          }
          _reply.readException();
          if ((0!=_reply.readInt())) {
      ...
      @Override public void storePosition(long bookId, org.geometerplus.android.fbreader.libraryService.PositionWithTimestamp position) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_storePosition, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().storePosition(bookId, position);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public boolean isHyperlinkVisited(java.lang.String book, java.lang.String linkId) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_isHyperlinkVisited, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().isHyperlinkVisited(book, linkId);
          }
          _reply.readException();
          _result = (0!=_reply.readInt());
        }
      ...
      @Override public void markHyperlinkAsVisited(java.lang.String book, java.lang.String linkId) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeString(book);
          _data.writeString(linkId);
          boolean _status = mRemote.transact(Stub.TRANSACTION_markHyperlinkAsVisited, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().markHyperlinkAsVisited(book, linkId);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public android.graphics.Bitmap getCover(java.lang.String book, int maxWidth, int maxHeight, boolean[] delayed) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_getCover, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getCover(book, maxWidth, maxHeight, delayed);
          }
          _reply.readException();
          if ((0!=_reply.readInt())) {
      ...
      @Override public java.util.List<java.lang.String> bookmarks(java.lang.String query) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeString(query);
          boolean _status = mRemote.transact(Stub.TRANSACTION_bookmarks, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().bookmarks(query);
          }
          _reply.readException();
          _result = _reply.createStringArrayList();
        }
      ...
      @Override public java.lang.String saveBookmark(java.lang.String bookmark) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_saveBookmark, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().saveBookmark(bookmark);
          }
          _reply.readException();
          _result = _reply.readString();
        }
      ...
      @Override public void deleteBookmark(java.lang.String bookmark) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeString(bookmark);
          boolean _status = mRemote.transact(Stub.TRANSACTION_deleteBookmark, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().deleteBookmark(bookmark);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public java.lang.String getHighlightingStyle(int styleId) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_getHighlightingStyle, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getHighlightingStyle(styleId);
          }
          _reply.readException();
          _result = _reply.readString();
        }
      ...
      @Override public java.util.List<java.lang.String> highlightingStyles() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_highlightingStyles, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().highlightingStyles();
          }
          _reply.readException();
          _result = _reply.createStringArrayList();
        }
      ...
      @Override public void saveHighlightingStyle(java.lang.String style) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_saveHighlightingStyle, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().saveHighlightingStyle(style);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public void rescan(java.lang.String path) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_rescan, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().rescan(path);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public void setHash(java.lang.String book, java.lang.String hash) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeString(book);
          _data.writeString(hash);
          boolean _status = mRemote.transact(Stub.TRANSACTION_setHash, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().setHash(book, hash);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public java.lang.String getCoverUrl(java.lang.String bookPath) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_getCoverUrl, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getCoverUrl(bookPath);
          }
          _reply.readException();
          _result = _reply.readString();
        }
      ...
      @Override public java.lang.String getDescription(java.lang.String book) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeString(book);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getDescription, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getDescription(book);
          }
          _reply.readException();
          _result = _reply.readString();
        }
      ...
      @Override public java.util.List<java.lang.String> recentlyAddedBooks(int count) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_recentlyAddedBooks, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().recentlyAddedBooks(count);
          }
          _reply.readException();
          _result = _reply.createStringArrayList();
        }
      ...
      @Override public java.util.List<java.lang.String> recentlyOpenedBooks(int count) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(count);
          boolean _status = mRemote.transact(Stub.TRANSACTION_recentlyOpenedBooks, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().recentlyOpenedBooks(count);
          }
          _reply.readException();
          _result = _reply.createStringArrayList();
        }
      ...
      @Override public void removeFromRecentlyOpened(java.lang.String book) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeString(book);
          boolean _status = mRemote.transact(Stub.TRANSACTION_removeFromRecentlyOpened, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().removeFromRecentlyOpened(book);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public boolean canRemoveBook(java.lang.String book, boolean deleteFromDisk) throws android.os.RemoteException
      {
        ...
        try {
          ...
          _data.writeString(book);
          _data.writeInt(((deleteFromDisk)?(1):(0)));
          boolean _status = mRemote.transact(Stub.TRANSACTION_canRemoveBook, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().canRemoveBook(book, deleteFromDisk);
          }
          _reply.readException();
          _result = (0!=_reply.readInt());
        }
      ...
      @Override public java.util.List<java.lang.String> formats() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_formats, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().formats();
          }
          _reply.readException();
          _result = _reply.createStringArrayList();
        }
      ...
      @Override public boolean setActiveFormats(java.util.List<java.lang.String> formats) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_setActiveFormats, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().setActiveFormats(formats);
          }
          _reply.readException();
          _result = (0!=_reply.readInt());
        }
      ...
      @Override public java.util.List<java.lang.String> deletedBookmarkUids() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_deletedBookmarkUids, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().deletedBookmarkUids();
          }
          _reply.readException();
          _result = _reply.createStringArrayList();
        }
      ...
      @Override public void purgeBookmarks(java.util.List<java.lang.String> uids) throws android.os.RemoteException
      {
        ...
        try {
          ...
          boolean _status = mRemote.transact(Stub.TRANSACTION_purgeBookmarks, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().purgeBookmarks(uids);
            return;
          }
          _reply.readException();
        }
      ...
      @Override public int getDefaultHighlightingStyleId() throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          boolean _status = mRemote.transact(Stub.TRANSACTION_getDefaultHighlightingStyleId, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            return getDefaultImpl().getDefaultHighlightingStyleId();
          }
          _reply.readException();
          _result = _reply.readInt();
        }
      ...
      @Override public void setDefaultHighlightingStyleId(int styleId) throws android.os.RemoteException
      {
        ...
        try {
          _data.writeInterfaceToken(DESCRIPTOR);
          _data.writeInt(styleId);
          boolean _status = mRemote.transact(Stub.TRANSACTION_setDefaultHighlightingStyleId, _data, _reply, 0);
          if (!_status && getDefaultImpl() != null) {
            getDefaultImpl().setDefaultHighlightingStyleId(styleId);
            return;
          }
          _reply.readException();
        }
      ...
      public static org.geometerplus.android.fbreader.libraryService.LibraryInterface sDefaultImpl;
    }
    ...
    public static boolean setDefaultImpl(org.geometerplus.android.fbreader.libraryService.LibraryInterface impl) {
    ...
    public static org.geometerplus.android.fbreader.libraryService.LibraryInterface getDefaultImpl() {
